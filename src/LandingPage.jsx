...
export default function LandingPage() {
  ...
  return (
    <div className="font-sans">
      ...
      <section className="bg-blue-50 px-8 py-10 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2">
          ...
          <div className="mt-6 flex justify-center gap-4">
            <button data-aos="fade-right" className="bg-blue-600 text-white px-6 py-3 hover:text-blue-600 hover:bg-white rounded-lg">
              Prendre Rendez-vous
            </button>
            <Link to="/patients">
            <button data-aos="fade-left" className="border border-blue-600 text-blue-600 hover:text-white hover:bg-blue-600 px-6 py-3 rounded-lg">
      ...
      <section className="px-8 py-20 bg-white">
        ...
        <div data-aos="fade-right" className="h-1 -mt-5 mb-5 bg-blue-700 w-80 flex justify-self-center"></div>
      ...
      <section className="px-8 py-20 bg-gray-50">
        ...
        <div data-aos="zoom-out" className="h-1 -mt-10 mb-5 bg-blue-700 w-50 flex justify-self-center"></div>
      ...
      <section className="px-8 py-20 bg-white">
        ...
        <div data-aos="fade-right" className="h-1 -mt-10 mb-5 bg-blue-700 w-100 flex justify-self-center"></div>
      ...
      <section className="px-8 py-20 bg-gray-50">
        ...
        <div data-aos="fade-right" className="h-1 -mt-10 mb-5 bg-blue-700 w-50 flex justify-self-center"></div>
