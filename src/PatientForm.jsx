...
export default function PatientForm() {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <input name="nom" placeholder="Nom" value={patient.nom} onChange={handleChange} required />
      <input name="prenom" placeholder="Prénom" value={patient.prenom} onChange={handleChange} required />
      <input type="date" name="dateNaissance" value={patient.dateNaissance} onChange={handleChange} required />
      <input name="telephone" placeholder="Téléphone" value={patient.telephone} onChange={handleChange} />
